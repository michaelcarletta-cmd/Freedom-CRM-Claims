...
const gradientButtonStyles =
  "border border-blue-200/80 bg-[linear-gradient(135deg,#1d4ed8_0%,#2563eb_55%,#ffffff_130%)] text-white shadow-sm hover:bg-[linear-gradient(135deg,#1e40af_0%,#1d4ed8_55%,#dbeafe_130%)] hover:shadow-md";
