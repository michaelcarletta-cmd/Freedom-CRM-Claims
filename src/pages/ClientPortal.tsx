      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">View your claims and provide updates</p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{claim.insurance_company || "N/A"}</p>
                    </div>
                    <div>
                  ...
                  <div>
                    <h3 className="font-medium mb-4">Updates & Communication</h3>
